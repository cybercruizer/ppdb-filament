...
return [
     ...
     */
    'site_name' => env('SEO_SITE_NAME', 'SPMB Nama Sekolah'),
    ...
    'title' => [
         ...
         */
        'homepage_title' => env('SEO_SITE_NAME', 'SPMB Nama Sekolah'),
    ],
    ...
    'description' => [
         ...
         */
        'fallback' => 'Informasi Sistem Penerimaan Murid Baru '.env('SEO_SITE_NAME', 'SPMB Nama Sekolah'),
    ],
