...
<head>
    ...
    <meta name="description" content="Cek status pendaftar SPMB ". {{ $pengaturan->where('key', 'nama_sekolah')->value('value') }}>
    <meta name="author" content="admin">
    <meta name="image" content="/img/cover.png">
    <link href="favicon.ico" rel="shortcut icon">
    <meta property="og:description" content="Cek status pendaftar SPMB ". {{ $pengaturan->where('key', 'nama_sekolah')->value('value') }}>
    ...
    <meta property="og:url"
        content="{{url()->current()}}">
    <meta property="og:site_name" content="SPMB ". {{ $pengaturan->where('key', 'nama_sekolah')->value('value') }}>
    <meta name="twitter:card" content="summary">
    <meta name="twitter:description" content="Cek status pendaftar SPMB ". {{ $pengaturan->where('key', 'nama_sekolah')->value('value') }}>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cek Status {{ $pengaturan->where('key', 'nama_sekolah')->value('value') }}</title>
    ...
    <footer class="footer" id="kontak">
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <p><i class="fab fa-whatsapp"></i> Admin1: <a
                        href="https://wa.me/{{ $pengaturan->where('key', 'admin_1')->value('value') }}">+{{ $pengaturan->where('key', 'admin_1')->value('value') }}</a>
                </p>
                <p><i class="fab fa-whatsapp"></i> Admin2: <a
                        href="https://wa.me/{{ $pengaturan->where('key', 'admin_2')->value('value') }}">+{{ $pengaturan->where('key', 'admin_2')->value('value') }}</a>
                </p>
                <p><i class="fab fa-whatsapp"></i> Admin3: <a
                        href="https://wa.me/{{ $pengaturan->where('key', 'admin_3')->value('value') }}">+{{ $pengaturan->where('key', 'admin_3')->value('value') }}</a>
                </p>
            </div>
