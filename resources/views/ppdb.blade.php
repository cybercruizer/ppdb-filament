...
<body>
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h3>Kontak</h3>
                <p><i class="fas fa-map-marker-alt"></i> Jl. Raya Mungkid, Magelang, Jawa Tengah</p>
                <p><i class="fas fa-phone"></i> (0293) 123456</p>
                <p><i class="fas fa-envelope"></i> info@smkmuhammadiyahmungkid.sch.id</p>
            </div>
