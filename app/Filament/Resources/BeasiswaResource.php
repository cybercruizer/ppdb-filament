...
class BeasiswaResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('kode_beasiswa')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('nama_beasiswa')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('potongan_biaya')
                    ->required()
                    ->maxLength(255),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('kode_beasiswa')
                    ->searchable(),
                Tables\Columns\TextColumn::make('nama_beasiswa')
                    ->searchable(),
                Tables\Columns\TextColumn::make('potongan_biaya')
                    ->searchable(),
