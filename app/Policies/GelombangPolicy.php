...
class GelombangPolicy
{
    ...
    {
        return $user->can('restore_any_gelombang');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Gelombang $gelombang): bool
    {
        return $user->can('replicate_gelombang');
    }
    ...
    {
        return $user->can('reorder_gelombang');
    }
}
